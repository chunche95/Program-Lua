...
local halfW = display.viewableContentWidth / 1.5
local halfH = display.viewableContentHeight / 4
...
local pelota = display.newImage("pelota.gif",25,20) -- Localizacion inicial de la pelota 
...
-- Plataforma
local plataforma = display.newRect(100/3,centerY + 200 ,ancho,10)
physics.addBody ( plataforma, "static", { density=.8, friction=0.7, bounce= 0.8})
plataforma:setFillColor(0.72, 1.9, 0.16, 0.1)
--plataforma:setFillColor(red, green, blue, alpha)
--Dibujo del bloques
